...
le cas du corpus de Trump est passionnant car il donne toute la production d'un locuteur au cours du temps. Le plus souvent les corpus sont constitués de locuteurs multiples dont les niveaux d'engagement sont très variables, un petit nombre publie souvent, et la majorité de manière épisodique.
...
<!--chapter:end:08-cooccurence_network.Rmd-->
...
<!--chapter:end:13-Topic-analysis.Rmd-->
