...
La collecte peut se faire d'abord sur des matiériaux primaire, numérisé sous forme d'images, et dans lesquels en analusant les pixels on peut reconnaitre un texte. 

### la numérisation

D'immenses archives sont numérisées, quand du texte est dans les images il faut le détecter

l'Ocr a fait d'immense progrès et prédit avec un erreur du demi pourt cent de qui est vrai.
...
Plusieur package sur r permettent d'interroger le fire nose, c'est àdire le sytème d'acces que twitter a organisé.
...
Dans un corpus massif il est souvent néçéssaire de filtrer le contenu d'éléments qui sortent du champs d'étude. POur étudier l'opinion utile écarter d'analyser ce qui est produit par les bots ou les trolls.
