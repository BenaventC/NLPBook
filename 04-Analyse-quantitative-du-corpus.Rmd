...
```{r 406, fig.cap='Evolution de la lisibilité moyenne des tweets de Trump', out.width='80%', fig.asp=.75, fig.align='center'}
...
#on se concentre du les termes utilisés 100 fois.  
...
Et pour faire des comparaisons .....

année 2016 qui le conduit à être élu, une année de mid term en 2018 et 2020 année de sa défaite.


```{r 407, fig.cap='Evolution de la lisibilité moyenne des tweets de Trump', out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r 410, fig.cap=' ', out.width='80%', fig.asp=.75, fig.align='center'}
```
