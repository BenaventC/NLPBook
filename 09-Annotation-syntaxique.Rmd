...
```{r 901, fig.cap='p', out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r 903, fig.cap='p', out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r 905, fig.width=8, fig.height=7, caption ="Réseaux sémantiques"}
